...
} from "./chunk-233NJFFL.js";
import {
  createSvgIcon,
  useId_default
} from "./chunk-NEUAMX2P.js";
import {
  useTheme
} from "./chunk-BPPEJZS3.js";
import {
  styled_default as styled_default2
} from "./chunk-6UZOJOMU.js";
import "./chunk-I4GC6YAJ.js";
import {
  alpha,
  clsx_default,
  darken,
...
} from "./chunk-DGPUVSC3.js";
import {
  _toPropertyKey
} from "./chunk-JOEXCGTR.js";
import "./chunk-W5WZF6IX.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  require_prop_types
} from "./chunk-WCZBYDNQ.js";
import "./chunk-OTP5XTMR.js";
import {
  require_jsx_runtime
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/getValidReactChildren.js
...
var GridPrivateApiContext = React15.createContext(void 0);
if (true) {
  GridPrivateApiContext.displayName = "GridPrivateApiContext";
}
function useGridPrivateApiContext() {
  const privateApiRef = React15.useContext(GridPrivateApiContext);
...
var GridMainContainer = React19.forwardRef((props, ref) => {
  var _rootProps$experiment;
  const rootProps = useGridRootProps();
...
function GridBody(props) {
  ...
  const columnHeadersRef = React20.useRef(null);
  const columnsContainerRef = React20.useRef(null);
  const virtualScrollerRef = React20.useRef(null);
...
function GridOverlayWrapper(props) {
  ...
  const rootProps = useGridRootProps();
  const [viewportInnerSize, setViewportInnerSize] = React22.useState(() => {
    var _apiRef$current$getRo, _apiRef$current$getRo2;
    return (_apiRef$current$getRo = (_apiRef$current$getRo2 = apiRef.current.getRootDimensions()) == null ? void 0 : _apiRef$current$getRo2.viewportInnerSize) != null ? _apiRef$current$getRo : null;
  });
  const handleViewportSizeChange = React22.useCallback(() => {
...
function useGridParamsApi(apiRef, props) {
  ...
  const getColumnHeaderParams = React25.useCallback((field) => ({
    field,
    colDef: apiRef.current.getColumn(field)
  }), [apiRef]);
  const getRowParams = React25.useCallback((id) => {
  ...
  const getBaseCellParams = React25.useCallback((id, field) => {
    const row = apiRef.current.getRow(id);
  ...
  const getCellParams = React25.useCallback((id, field) => {
  ...
  const getCellValue = React25.useCallback((id, field) => {
    const colDef = apiRef.current.getColumn(field);
  ...
  const getRowValue = React25.useCallback((row, colDef) => {
    var _getRowId;
  ...
  const getRowFormattedValue = React25.useCallback((row, colDef) => {
    var _ref;
  ...
  const getColumnHeaderElement = React25.useCallback((field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridColumnHeaderElement(apiRef.current.rootElementRef.current, field);
  }, [apiRef]);
  const getRowElement = React25.useCallback((id) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridRowElement(apiRef.current.rootElementRef.current, id);
  }, [apiRef]);
  const getCellElement = React25.useCallback((id, field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
...
var GridCellWrapper = React26.forwardRef((props, ref) => {
  const {
    column,
    rowId,
    editCellState
  ...
  return React26.createElement(CellComponent, cellProps);
});
var GridCell = React26.forwardRef((props, ref) => {
  ...
  const cellRef = React26.useRef(null);
  const handleRef = useForkRef(ref, cellRef);
  const focusElementRef = React26.useRef(null);
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const ownerState = {
    align,
  ...
  const publishMouseUp = React26.useCallback((eventName) => (event) => {
  ...
  const publishMouseDown = React26.useCallback((eventName) => (event) => {
    const params = apiRef.current.getCellParams(rowId, field || "");
    apiRef.current.publishEvent(eventName, params, event);
    if (onMouseDown) {
      onMouseDown(event);
  ...
  if (React26.isValidElement(children) && managesOwnFocus) {
...
var GridCellV7 = React26.forwardRef((props, ref) => {
  ...
  if (React26.isValidElement(children) && canManageOwnFocus) {
    children = React26.cloneElement(children, {
      focusElementRef
    });
  }
...
function GridBooleanCellRaw(props) {
  ...
  const Icon = React27.useMemo(() => value ? rootProps.slots.booleanCellTrueIcon : rootProps.slots.booleanCellFalseIcon, [rootProps.slots.booleanCellFalseIcon, rootProps.slots.booleanCellTrueIcon, value]);
...
var GridBooleanCell = React27.memo(GridBooleanCellRaw);
...
function GridEditDateCell(props) {
  ...
  const valueTransformed = React29.useMemo(() => {
    let parsedDate;
    if (valueProp == null) {
      parsedDate = null;
  ...
  const [valueState, setValueState] = React29.useState(valueTransformed);
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  };
  const classes = useUtilityClasses6(ownerState);
  const parseValueToDate = React29.useCallback((value) => {
    if (value === "") {
      return null;
    }
  ...
  const handleChange = React29.useCallback(async (event) => {
...
var GridEditInputCell = React30.forwardRef((props, ref) => {
  const rootProps = useGridRootProps();
  const {
    id,
    value,
  ...
  const [valueState, setValueState] = React30.useState(value);
  const classes = useUtilityClasses7(rootProps);
  const handleChange = React30.useCallback(async (event) => {
...
function GridEditSingleSelectCell(props) {
  ...
  const [open, setOpen] = React31.useState(initialOpen);
...
function GridMenu(props) {
  ...
  const savedFocusRef = React32.useRef(null);
  useEnhancedEffect_default(() => {
    if (open) {
...
function GridActionsCell(props) {
  ...
  const [focusedButtonIndex, setFocusedButtonIndex] = React33.useState(-1);
  const [open, setOpen] = React33.useState(false);
  const apiRef = useGridApiContext();
  const rootRef = React33.useRef(null);
  const buttonRef = React33.useRef(null);
  const ignoreCallToFocus = React33.useRef(false);
  const touchRippleRefs = React33.useRef({});
  ...
  React33.useImperativeHandle(focusElementRef, () => ({
    focus() {
  ...
  return (0, import_jsx_runtime14.jsxs)("div", _extends({
    ...
    children: [iconButtons.map((button, index) => React33.cloneElement(button, {
      key: index,
      ...
      children: (0, import_jsx_runtime13.jsx)(MenuList_default, {
        ...
        variant: "menu",
        autoFocusItem: true,
        children: menuButtons.map((button, index) => React33.cloneElement(button, {
          key: index
        }))
      })
    })]
...
var GridActionsCellItem = React34.forwardRef((props, ref) => {
  const {
    label,
    icon,
    showInMenu,
  ...
  if (!showInMenu) {
    ...
    return (0, import_jsx_runtime15.jsx)(rootProps.slots.baseIconButton, _extends({
      ...
      children: React34.cloneElement(icon, {
        fontSize: "small"
      })
    }));
  }
...
var GridRoot = React36.forwardRef(function GridRoot2(props, ref) {
  var _rootProps$experiment;
  const rootProps = useGridRootProps();
  const {
    children,
  ...
  const rootContainerRef = React36.useRef(null);
...
var GridFooterContainer = React37.forwardRef(function GridFooterContainer2(props, ref) {
  const {
    className
...
var GridOverlay = React38.forwardRef(function GridOverlay2(props, ref) {
  const {
    className
...
var GridToolbarContainer = React39.forwardRef(function GridToolbarContainer2(props, ref) {
  const {
    className,
    children
...
var GridIconButtonContainer = React40.forwardRef(function GridIconButtonContainer2(props, ref) {
  const {
    className
...
var GridColumnHeaderSortIcon = React41.memo(GridColumnHeaderSortIconRaw);
...
var ColumnHeaderMenuIcon = React42.memo((props) => {
  ...
  const handleMenuIconClick = React42.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
...
var ColumnHeaderInnerTitle = React44.forwardRef(function ColumnHeaderInnerTitle2(props, ref) {
  const {
    className
...
function GridColumnHeaderTitle(props) {
  ...
  const [tooltip, setTooltip] = React44.useState("");
  const handleMouseOver = React44.useCallback(() => {
...
function GridColumnHeaderSeparatorRaw(props) {
  ...
  const stopClick = React45.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
  }, []);
  return (
...
var GridColumnHeaderSeparator = React45.memo(GridColumnHeaderSeparatorRaw);
...
var GridGenericColumnHeaderItem = React46.forwardRef(function GridGenericColumnHeaderItem2(props, ref) {
  const {
    classes,
    columnMenuOpen,
    colIndex,
  ...
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React46.useRef(null);
  const [showColumnMenuIcon, setShowColumnMenuIcon] = React46.useState(columnMenuOpen);
...
function GridColumnHeaderItem(props) {
  ...
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React47.useRef(null);
  const columnMenuId = useId();
  const columnMenuButtonId = useId();
  const iconButtonRef = React47.useRef(null);
  const [showColumnMenuIcon, setShowColumnMenuIcon] = React47.useState(columnMenuOpen);
  const isDraggable = React47.useMemo(() => !rootProps.disableColumnReorder && !disableReorder && !colDef.disableReorder, [rootProps.disableColumnReorder, disableReorder, colDef.disableReorder]);
  let headerComponent;
  ...
  const publish = React47.useCallback((eventName) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    apiRef.current.publishEvent(eventName, apiRef.current.getColumnHeaderParams(colDef.field), event);
  }, [apiRef, colDef.field]);
  const mouseEventsHandlers = React47.useMemo(() => ({
  ...
  const draggableEventHandlers = React47.useMemo(() => isDraggable ? {
    onDragStart: publish("columnHeaderDragStart"),
    onDragEnter: publish("columnHeaderDragEnter"),
    onDragOver: publish("columnHeaderDragOver"),
    onDragEnd: publish("columnHeaderDragEnd")
  } : {}, [isDraggable, publish]);
  const columnHeaderSeparatorProps = React47.useMemo(() => ({
  ...
  const columnTitleIconButtons = (0, import_jsx_runtime32.jsxs)(React47.Fragment, {
...
function createUseGridApiEventHandler(registryContainer2) {
  ...
  return function useGridApiEventHandler2(apiRef, eventName, handler, options) {
    ...
    const [objectRetainedByReact] = React48.useState(new ObjectToBeRetainedByReact());
    const subscription = React48.useRef(null);
    const handlerRef = React48.useRef();
    handlerRef.current = handler;
    const cleanupTokenRef = React48.useRef(null);
...
function useGridLogger(privateApiRef, name) {
  const logger = React49.useRef(null);
  if (logger.current) {
...
var useGridNativeEventListener = (apiRef, ref, eventName, handler, options) => {
  ...
  const [added, setAdded] = React50.useState(false);
  const handlerRef = React50.useRef(handler);
  const wrapHandler = React50.useCallback((event) => {
...
var useFirstRender = (callback) => {
  const isFirstRender = React51.useRef(true);
  if (isFirstRender.current) {
    isFirstRender.current = false;
    callback();
  }
...
function GridColumnHeaderFilterIconButton(props) {
  ...
  const labelId = useId();
  const panelId = useId();
  const toggleFilter = React53.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
    const {
      open: open2,
...
var GridCellCheckboxForwardRef = React54.forwardRef(function GridCellCheckboxRenderer(props, ref) {
  var _rootProps$slotProps;
  const {
    field,
    id,
  ...
  const checkboxElement = React54.useRef(null);
...
var GridHeaderCheckbox = React55.forwardRef(function GridHeaderCheckbox2(props, ref) {
  var _rootProps$slotProps;
  const other = _objectWithoutPropertiesLoose(props, _excluded24);
  const [, forceUpdate] = React55.useState(false);
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  ...
  const filteredSelection = React55.useMemo(() => {
  ...
  const selectionCandidates = React55.useMemo(() => {
  ...
  const currentSelectionSize = React55.useMemo(() => filteredSelection.filter((id) => selectionCandidates[id]).length, [filteredSelection, selectionCandidates]);
  ...
  const handleSelectionChange = React55.useCallback(() => {
    forceUpdate((p) => !p);
  }, []);
  React55.useEffect(() => {
...
var GridColumnMenuContainer = React57.forwardRef(function GridColumnMenuContainer2(props, ref) {
  const {
    hideMenu,
    id,
    labelledby,
  ...
  const handleListKeyDown = React57.useCallback((event) => {
...
var useGridColumnMenuSlots = (props) => {
  ...
  const processedComponents = React58.useMemo(() => _extends({}, defaultSlots2, slots), [defaultSlots2, slots]);
  const processedSlotProps = React58.useMemo(() => {
  ...
  const userItems = React58.useMemo(() => {
...
function GridColumnMenuHideItem(props) {
  ...
  const toggleColumn = React59.useCallback((event) => {
    if (disabled) {
      return;
    }
...
function GridColumnMenuManageItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showColumns = React60.useCallback((event) => {
    onClick(event);
...
function GridColumnMenuColumnsItem(props) {
  return (0, import_jsx_runtime44.jsxs)(React61.Fragment, {
...
function GridColumnMenuFilterItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showFilter = React62.useCallback((event) => {
    onClick(event);
...
function GridColumnMenuSortItem(props) {
  ...
  const rootProps = useGridRootProps();
  const sortDirection = React63.useMemo(() => {
    if (!colDef) {
      return null;
    }
  ...
  const sortingOrder = (_colDef$sortingOrder = colDef.sortingOrder) != null ? _colDef$sortingOrder : rootProps.sortingOrder;
  const onSortMenuItemClick = React63.useCallback((event) => {
    onClick(event);
...
var GridGenericColumnMenu = React64.forwardRef(function GridGenericColumnMenu2(props, ref) {
  const {
    defaultSlots: defaultSlots2,
    defaultSlotProps,
    slots,
...
var GridColumnMenu = React64.forwardRef(function GridColumnMenu2(props, ref) {
...
var GridToolbarDensitySelector = React81.forwardRef(function GridToolbarDensitySelector2(props, ref) {
  ...
  return (0, import_jsx_runtime72.jsxs)(React81.Fragment, {
...
var GridToolbarExportContainer = React83.forwardRef(function GridToolbarExportContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime76.jsxs)(React83.Fragment, {
...
function GridHeader() {
  var _rootProps$slotProps, _rootProps$slotProps2;
  const rootProps = useGridRootProps();
  return (0, import_jsx_runtime85.jsxs)(React89.Fragment, {
...
var GridLoadingOverlay = React90.forwardRef(function GridLoadingOverlay2(props, ref) {
...
var GridNoRowsOverlay = React91.forwardRef(function GridNoRowsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var GridPagination = React92.forwardRef(function GridPagination2(props, ref) {
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const paginationModel = useGridSelector(apiRef, gridPaginationModelSelector);
  const visibleTopLevelRowCount = useGridSelector(apiRef, gridFilteredTopLevelRowCountSelector);
  const rowCount = React92.useMemo(() => {
    var _ref, _rootProps$rowCount;
    return (_ref = (_rootProps$rowCount = rootProps.rowCount) != null ? _rootProps$rowCount : visibleTopLevelRowCount) != null ? _ref : 0;
  }, [rootProps.rowCount, visibleTopLevelRowCount]);
  const lastPage = React92.useMemo(() => Math.floor(rowCount / (paginationModel.pageSize || 1)), [rowCount, paginationModel.pageSize]);
  const handlePageSizeChange = React92.useCallback((event) => {
    const pageSize = Number(event.target.value);
    apiRef.current.setPageSize(pageSize);
  }, [apiRef]);
  const handlePageChange = React92.useCallback((_, page) => {
  ...
  if (true) {
    ...
    const warnedOnceMissingInPageSizeOptions = React92.useRef(false);
...
var GridRowCount = React93.forwardRef(function GridRowCount2(props, ref) {
  const {
    className,
    rowCount,
    visibleRowCount
...
var GridRow = React96.forwardRef(function GridRow2(props, refProp) {
  const {
    selected,
    hovered,
    rowId,
  ...
  const publish = React96.useCallback((eventName, propHandler) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    if (!apiRef.current.getRow(rowId)) {
  ...
  const publishClick = React96.useCallback((event) => {
...
function GridContextProvider({
  ...
  const apiRef = React97.useRef(privateApiRef.current.getPublicApi());
...
var useGridLoggerFactory = (apiRef, props) => {
  const getLogger = React98.useCallback((name) => {
    if (forceDebug) {
...
function useGridApiInitialization(inputApiRef, props) {
  const publicApiRef = React99.useRef();
  const privateApiRef = React99.useRef();
  ...
  const publishEvent = React99.useCallback((...args) => {
  ...
  const subscribeEvent = React99.useCallback((event, handler, options) => {
  ...
  React99.useImperativeHandle(inputApiRef, () => publicApiRef.current, [publicApiRef]);
  React99.useEffect(() => {
    const api = privateApiRef.current;
    return () => {
...
var useGridLocaleText = (apiRef, props) => {
  const getLocaleText = React100.useCallback((key) => {
...
var useGridPipeProcessing = (apiRef) => {
  const processorsCache = React101.useRef({});
  const isRunning = React101.useRef(false);
  const runAppliers = React101.useCallback((groupCache) => {
  ...
  const registerPipeProcessor = React101.useCallback((group, id, processor) => {
  ...
  const registerPipeApplier = React101.useCallback((group, id, applier) => {
    if (!processorsCache.current[group]) {
      processorsCache.current[group] = {
        processors: /* @__PURE__ */ new Map(),
        appliers: {}
  ...
  const requestPipeProcessorsApplication = React101.useCallback((group) => {
    const groupCache = processorsCache.current[group];
    runAppliers(groupCache);
  }, [runAppliers]);
  const applyPipeProcessors = React101.useCallback((...args) => {
...
var useGridRegisterPipeProcessor = (apiRef, group, callback) => {
  const cleanup = React102.useRef();
  const id = React102.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React102.useCallback(() => {
    cleanup.current = apiRef.current.registerPipeProcessor(group, id.current, callback);
  }, [apiRef, callback, group]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React102.useRef(true);
  React102.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridRegisterPipeApplier = (apiRef, group, callback) => {
  const cleanup = React103.useRef();
  const id = React103.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React103.useCallback(() => {
    cleanup.current = apiRef.current.registerPipeApplier(group, id.current, callback);
  }, [apiRef, callback, group]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React103.useRef(true);
  React103.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridRegisterStrategyProcessor = (apiRef, strategyName, group, processor) => {
  const registerPreProcessor = React104.useCallback(() => {
    apiRef.current.registerStrategyProcessor(strategyName, group, processor);
  }, [apiRef, processor, group, strategyName]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React104.useRef(true);
  React104.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridStrategyProcessing = (apiRef) => {
  const availableStrategies = React105.useRef(/* @__PURE__ */ new Map());
  const strategiesCache = React105.useRef({});
  const registerStrategyProcessor = React105.useCallback((strategyName, processorName, processor) => {
    const cleanup = () => {
  ...
  const applyStrategyProcessor = React105.useCallback((processorName, params) => {
  ...
  const getActiveStrategy = React105.useCallback((strategyGroup) => {
  ...
  const setStrategyAvailability = React105.useCallback((strategyGroup, strategyName, isAvailable) => {
...
var useGridStateInitialization = (apiRef, props) => {
  const controlStateMapRef = React106.useRef({});
  const [, rawForceUpdate] = React106.useState();
  const registerControlState = React106.useCallback((controlStateItem) => {
    controlStateMapRef.current[controlStateItem.stateId] = controlStateItem;
  }, []);
  const setState = React106.useCallback((state, reason) => {
    let newState;
    if (isFunction(state)) {
  ...
  const updateControlState = React106.useCallback((key, state, reason) => {
  ...
  const forceUpdate = React106.useCallback(() => rawForceUpdate(() => apiRef.current.state), [apiRef]);
...
var useGridInitializeState = (initializer, privateApiRef, props) => {
  const isInitialized = React107.useRef(false);
...
var useGridClipboard = (apiRef, props) => {
  ...
  const handleCopy = React108.useCallback((event) => {
...
var useGridColumnMenu = (apiRef) => {
  ...
  const showColumnMenu = React109.useCallback((field) => {
  ...
  const hideColumnMenu = React109.useCallback(() => {
  ...
  const toggleColumnMenu = React109.useCallback((field) => {
...
function useGridColumns(apiRef, props) {
  ...
  const previousColumnsProp = React110.useRef(props.columns);
  const previousColumnTypesProp = React110.useRef(columnTypes);
  ...
  const setGridColumnsState = React110.useCallback((columnsState) => {
    logger.debug("Updating columns state.");
    apiRef.current.setState(mergeColumnsState(columnsState));
    apiRef.current.forceUpdate();
    apiRef.current.publishEvent("columnsChange", columnsState.orderedFields);
  }, [logger, apiRef]);
  const getColumn = React110.useCallback((field) => gridColumnLookupSelector(apiRef)[field], [apiRef]);
  const getAllColumns = React110.useCallback(() => gridColumnDefinitionsSelector(apiRef), [apiRef]);
  const getVisibleColumns = React110.useCallback(() => gridVisibleColumnDefinitionsSelector(apiRef), [apiRef]);
  const getColumnIndex = React110.useCallback((field, useVisibleColumns = true) => {
    const columns = useVisibleColumns ? gridVisibleColumnDefinitionsSelector(apiRef) : gridColumnDefinitionsSelector(apiRef);
    return columns.findIndex((col) => col.field === field);
  }, [apiRef]);
  const getColumnPosition = React110.useCallback((field) => {
    const index = getColumnIndex(field);
    return gridColumnPositionsSelector(apiRef)[index];
  }, [apiRef, getColumnIndex]);
  const setColumnVisibilityModel = React110.useCallback((model) => {
    const currentModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const updateColumns = React110.useCallback((columns) => {
    const columnsState = createColumnsState({
      apiRef,
      columnTypes,
  ...
  const setColumnVisibility = React110.useCallback((field, isVisible) => {
  ...
  const getColumnIndexRelativeToVisibleColumns = React110.useCallback((field) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
    return allColumns.findIndex((col) => col === field);
  }, [apiRef]);
  const setColumnIndex = React110.useCallback((field, targetIndexPosition) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
  ...
  const setColumnWidth = React110.useCallback((field, width) => {
    var _apiRef$current$getRo, _apiRef$current$getRo2;
  ...
  const preferencePanelPreProcessing = React110.useCallback((initialValue, value) => {
  ...
  const addColumnMenuItems = React110.useCallback((columnMenuItems) => {
  ...
  const prevInnerWidth = React110.useRef(null);
  ...
  const hydrateColumns = React110.useCallback(() => {
...
var useGridDensity = (apiRef, props) => {
  ...
  const setDensity = React111.useCallback((newDensity) => {
...
var useGridCsvExport = (apiRef, props) => {
  ...
  const getDataAsCsv = React112.useCallback((options = {}) => {
  ...
  const exportDataAsCsv = React112.useCallback((options) => {
  ...
  const addExportMenuButtons = React112.useCallback((initialValue, options) => {
...
var useGridPagination = (apiRef, props) => {
  ...
  const setPage = React113.useCallback((page) => {
  ...
  const setPageSize = React113.useCallback((pageSize) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const setPaginationModel = React113.useCallback((paginationModel) => {
    var _props$rowCount;
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const handleUpdateAutoPageSize = React113.useCallback(() => {
...
var useGridPrintExport = (apiRef, props) => {
  ...
  const doc = React114.useRef(null);
  const previousGridState = React114.useRef(null);
  const previousColumnVisibility = React114.useRef({});
  const previousRows = React114.useRef([]);
  React114.useEffect(() => {
    doc.current = ownerDocument(apiRef.current.rootElementRef.current);
  }, [apiRef]);
  const updateGridColumnsForPrint = React114.useCallback((fields, allColumns, includeCheckboxes) => new Promise((resolve) => {
  ...
  const updateGridRowsForPrint = React114.useCallback((getRowsToExport) => {
  ...
  const handlePrintWindowLoad = React114.useCallback((printWindow, options) => {
...
`;
  ...
  const handlePrintWindowAfterPrint = React114.useCallback((printWindow) => {
  ...
  const exportDataAsPrint = React114.useCallback(async (options) => {
  ...
  const addExportMenuButtons = React114.useCallback((initialValue, options) => {
...
var useGridFilter = (apiRef, props) => {
  ...
  const updateFilteredRows = React115.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const applyFilters = React115.useCallback(() => {
    updateFilteredRows();
    apiRef.current.forceUpdate();
  }, [apiRef, updateFilteredRows]);
  const upsertFilterItem = React115.useCallback((item) => {
  ...
  const upsertFilterItems = React115.useCallback((items) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const deleteFilterItem = React115.useCallback((itemToDelete) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const showFilterPanel = React115.useCallback((targetColumnField, panelId, labelId) => {
  ...
  const hideFilterPanel = React115.useCallback(() => {
    logger.debug("Hiding filter panel");
    apiRef.current.hidePreferences();
  }, [apiRef, logger]);
  const setFilterLogicOperator = React115.useCallback((logicOperator) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setQuickFilterValues = React115.useCallback((values) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setFilterModel = React115.useCallback((model, reason) => {
  ...
  const flatFilteringMethod = React115.useCallback((params) => {
  ...
  const updateVisibleRowsLookupState = React115.useCallback(() => {
    apiRef.current.setState((state) => {
      return _extends({}, state, {
...
var useGridFocus = (apiRef, props) => {
  ...
  const lastClickedCell = React116.useRef(null);
  const publishCellFocusOut = React116.useCallback((cell, event) => {
    if (cell) {
  ...
  const setCellFocus = React116.useCallback((id, field) => {
    const focusedCell = gridFocusCellSelector(apiRef);
  ...
  const setColumnHeaderFocus = React116.useCallback((field, event = {}) => {
  ...
  const setColumnHeaderFilterFocus = React116.useCallback((field, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    publishCellFocusOut(cell, event);
    apiRef.current.setState((state) => {
  ...
  const setColumnGroupHeaderFocus = React116.useCallback((field, depth, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    if (cell) {
      apiRef.current.publishEvent("cellFocusOut", apiRef.current.getCellParams(cell.id, cell.field), event);
    }
  ...
  const getColumnGroupHeaderFocus = React116.useCallback(() => unstable_gridFocusColumnGroupHeaderSelector(apiRef), [apiRef]);
  const moveFocusToRelativeCell = React116.useCallback((id, field, direction) => {
  ...
  const handleCellDoubleClick = React116.useCallback(({
    id,
    field
  }) => {
    apiRef.current.setCellFocus(id, field);
  }, [apiRef]);
  const handleCellKeyDown = React116.useCallback((params, event) => {
    if (event.key === "Enter" || event.key === "Tab" || event.key === "Shift" || isNavigationKey(event.key)) {
      return;
    }
    apiRef.current.setCellFocus(params.id, params.field);
  }, [apiRef]);
  const handleColumnHeaderFocus = React116.useCallback(({
    field
  }, event) => {
  ...
  const handleColumnGroupHeaderFocus = React116.useCallback(({
    fields,
    depth
  }, event) => {
    if (event.target !== event.currentTarget) {
  ...
  const handleBlur = React116.useCallback((_, event) => {
  ...
  const handleCellMouseDown = React116.useCallback((params) => {
    lastClickedCell.current = params;
  }, []);
  const handleDocumentClick = React116.useCallback((event) => {
  ...
  const handleCellModeChange = React116.useCallback((params) => {
  ...
  const handleRowSet = React116.useCallback(() => {
    const cell = gridFocusCellSelector(apiRef);
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const theme = useTheme();
  const currentPageRows = React117.useMemo(() => enrichPageRowsWithPinnedRows(apiRef, initialCurrentPageRows), [apiRef, initialCurrentPageRows]);
  const headerFilteringEnabled = (
    // @ts-expect-error // TODO move relevant code to the `DataGridPro`
    props.signature !== "DataGrid" && props.unstable_headerFilters
  );
  const goToCell = React117.useCallback((colIndex, rowId, closestColumnToUse = "left") => {
  ...
  const goToHeader = React117.useCallback((colIndex, event) => {
  ...
  const goToHeaderFilter = React117.useCallback((colIndex, event) => {
  ...
  const goToGroupHeader = React117.useCallback((colIndex, depth, event) => {
    logger.debug(`Navigating to header col ${colIndex}`);
    apiRef.current.scrollToIndexes({
      colIndex
    });
  ...
  const getRowIdFromIndex = React117.useCallback((rowIndex) => {
    var _currentPageRows$rowI;
    return (_currentPageRows$rowI = currentPageRows[rowIndex]) == null ? void 0 : _currentPageRows$rowI.id;
  }, [currentPageRows]);
  const handleColumnHeaderKeyDown = React117.useCallback((params, event) => {
  ...
  const handleHeaderFilterKeyDown = React117.useCallback((params, event) => {
    const dimensions = apiRef.current.getRootDimensions();
    if (!dimensions) {
      return;
    }
  ...
  const handleColumnGroupHeaderKeyDown = React117.useCallback((params, event) => {
    const dimensions = apiRef.current.getRootDimensions();
    if (!dimensions) {
      return;
    }
  ...
  const handleCellKeyDown = React117.useCallback((params, event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
  ...
  const checkIfCanStartEditing = React117.useCallback((initialValue, {
    event
  }) => {
    if (event.key === " ") {
      return false;
...
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const hideTimeout = React118.useRef();
  const immediateTimeout = React118.useRef();
  const hidePreferences = React118.useCallback(() => {
  ...
  const doNotHidePanel = React118.useCallback(() => {
    immediateTimeout.current = setTimeout(() => clearTimeout(hideTimeout.current), 0);
  }, []);
  const hidePreferencesDelayed = React118.useCallback(() => {
    hideTimeout.current = setTimeout(hidePreferences, 100);
  }, [hidePreferences]);
  const showPreferences = React118.useCallback((newValue, panelId, labelId) => {
...
var useGridCellEditing = (apiRef, props) => {
  const [cellModesModel, setCellModesModel] = React119.useState({});
  const cellModesModelRef = React119.useRef(cellModesModel);
  const prevCellModesModel = React119.useRef({});
  const {
    processRowUpdate,
  ...
  const throwIfNotEditable = React119.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React119.useCallback((id, field, mode) => {
    if (apiRef.current.getCellMode(id, field) !== mode) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React119.useCallback((params, event) => {
  ...
  const handleCellFocusOut = React119.useCallback((params, event) => {
  ...
  const handleCellKeyDown = React119.useCallback((params, event) => {
    if (params.cellMode === GridCellModes.Edit) {
      if (event.which === 229) {
        return;
      }
  ...
  const handleCellEditStart = React119.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleCellEditStop = React119.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const getCellMode = React119.useCallback((id, field) => {
  ...
  const updateFieldInCellModesModel = React119.useCallback((id, field, newProps) => {
  ...
  const updateOrDeleteFieldState = React119.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
  ...
  const startCellEditMode = React119.useCallback((params) => {
    const {
      id,
      field
  ...
  const stopCellEditMode = React119.useCallback((params) => {
    const {
      id,
      field
  ...
  const setCellEditingEditCellValue = React119.useCallback(async (params) => {
  ...
  const getRowWithUpdatedValuesFromCellEditing = React119.useCallback((id, field) => {
    const column = apiRef.current.getColumn(field);
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
...
var useGridRowEditing = (apiRef, props) => {
  const [rowModesModel, setRowModesModel] = React120.useState({});
  const rowModesModelRef = React120.useRef(rowModesModel);
  const prevRowModesModel = React120.useRef({});
  const focusTimeout = React120.useRef(null);
  const nextFocusedCell = React120.useRef(null);
  const {
    processRowUpdate,
    onProcessRowUpdateError,
  ...
  const throwIfNotEditable = React120.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React120.useCallback((id, mode) => {
    if (apiRef.current.getRowMode(id) !== mode) {
      throw new Error(`MUI: The row with id=${id} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React120.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellFocusIn = React120.useCallback((params) => {
    nextFocusedCell.current = params;
  }, []);
  const handleCellFocusOut = React120.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleRowEditStart = React120.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleRowEditStop = React120.useCallback((params) => {
    const {
      id,
      reason,
      field
  ...
  const getRowMode = React120.useCallback((id) => {
    if (props.editMode === GridEditModes.Cell) {
  ...
  const updateRowInRowModesModel = React120.useCallback((id, newProps) => {
  ...
  const updateOrDeleteRowState = React120.useCallback((id, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
  ...
  const updateOrDeleteFieldState = React120.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
        newEditingState[id] = _extends({}, newEditingState[id], {
  ...
  const startRowEditMode = React120.useCallback((params) => {
    const {
      id
  ...
  const stopRowEditMode = React120.useCallback((params) => {
    const {
      id
  ...
  const setRowEditingEditCellValue = React120.useCallback((params) => {
    const {
      id,
      field,
      value,
  ...
  const getRowWithUpdatedValuesFromRowEditing = React120.useCallback((id) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
    if (!editingState[id]) {
      return apiRef.current.getRow(id);
...
var useGridEditing = (apiRef, props) => {
  ...
  const debounceMap = React121.useRef({});
  const {
    isCellEditable: isCellEditableProp
  } = props;
  const isCellEditable = React121.useCallback((params) => {
    if (isAutoGeneratedRow(params.rowNode)) {
      return false;
    }
  ...
  const runPendingEditCellValueMutation = React121.useCallback((id, field) => {
    if (!debounceMap.current[id]) {
      return;
    }
    if (!field) {
  ...
  const setEditCellValue = React121.useCallback((params) => {
    const {
      id,
      field,
      debounceMs
  ...
  const getRowWithUpdatedValues = React121.useCallback((id, field) => {
    return props.editMode === GridEditModes.Cell ? apiRef.current.getRowWithUpdatedValuesFromCellEditing(id, field) : apiRef.current.getRowWithUpdatedValuesFromRowEditing(id);
  }, [apiRef, props.editMode]);
  const getEditCellMeta = React121.useCallback((id, field) => {
...
var useGridRows = (apiRef, props) => {
  ...
  const lastUpdateMs = React122.useRef(Date.now());
  const timeout = useTimeout();
  const getRow = React122.useCallback((id) => {
  ...
  const getRowId = React122.useCallback((row) => {
  ...
  const lookup = React122.useMemo(() => currentPage.rows.reduce((acc, {
    id
  }, index) => {
    acc[id] = index;
    return acc;
  }, {}), [currentPage.rows]);
  const throttledRowsChange = React122.useCallback(({
    cache,
    throttle
  }) => {
    const run = () => {
  ...
  const setRows = React122.useCallback((rows) => {
  ...
  const updateRows = React122.useCallback((updates) => {
  ...
  const getRowModels = React122.useCallback(() => {
  ...
  const getRowsCount = React122.useCallback(() => gridRowCountSelector(apiRef), [apiRef]);
  const getAllRowIds = React122.useCallback(() => gridDataRowIdsSelector(apiRef), [apiRef]);
  const getRowIndexRelativeToVisibleRows = React122.useCallback((id) => lookup[id], [lookup]);
  const setRowChildrenExpansion = React122.useCallback((id, isExpanded) => {
  ...
  const getRowNode = React122.useCallback((id) => {
    var _ref;
    return (_ref = gridRowTreeSelector(apiRef)[id]) != null ? _ref : null;
  }, [apiRef]);
  const getRowGroupChildren = React122.useCallback(({
  ...
  const setRowIndex = React122.useCallback((rowId, targetIndex) => {
  ...
  const replaceRows = React122.useCallback((firstRowToRender, newRows) => {
  ...
  const groupRows = React122.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React122.useCallback((methodName) => {
    if (methodName === "rowTreeCreation") {
      groupRows();
    }
  }, [groupRows]);
  const handleStrategyActivityChange = React122.useCallback(() => {
  ...
  const applyHydrateRowsProcessor = React122.useCallback(() => {
    apiRef.current.setState((state) => {
...
var useGridRowSelection = (apiRef, props) => {
  ...
  const propRowSelectionModel = React123.useMemo(() => {
    return getSelectionModelPropValue(props.rowSelectionModel, gridRowSelectionStateSelector(apiRef.current.state));
  }, [apiRef, props.rowSelectionModel]);
  const lastRowToggled = React123.useRef(null);
  apiRef.current.registerControlState({
  ...
  const expandMouseRowRangeSelection = React123.useCallback((id) => {
  ...
  const setRowSelectionModel = React123.useCallback((model) => {
  ...
  const isRowSelected = React123.useCallback((id) => gridRowSelectionStateSelector(apiRef.current.state).includes(id), [apiRef]);
  const isRowSelectable = React123.useCallback((id) => {
  ...
  const getSelectedRows = React123.useCallback(() => selectedGridRowsSelector(apiRef), [apiRef]);
  const selectRow = React123.useCallback((id, isSelected = true, resetSelection = false) => {
  ...
  const selectRows = React123.useCallback((ids, isSelected = true, resetSelection = false) => {
  ...
  const selectRowRange = React123.useCallback(({
    startId,
    endId
  ...
  const removeOutdatedSelection = React123.useCallback(() => {
  ...
  const handleSingleRowSelection = React123.useCallback((id, event) => {
  ...
  const handleRowClick = React123.useCallback((params, event) => {
    var _closest;
  ...
  const preventSelectionOnShift = React123.useCallback((params, event) => {
    if (canHaveMultipleSelection && event.shiftKey) {
      var _window$getSelection;
      (_window$getSelection = window.getSelection()) == null || _window$getSelection.removeAllRanges();
    }
  }, [canHaveMultipleSelection]);
  const handleRowSelectionCheckboxChange = React123.useCallback((params, event) => {
  ...
  const handleHeaderSelectionCheckboxChange = React123.useCallback((params) => {
    const shouldLimitSelectionToCurrentPage = props.checkboxSelectionVisibleOnly && props.pagination;
    const rowsToBeSelected = shouldLimitSelectionToCurrentPage ? gridPaginatedVisibleSortedGridRowIdsSelector(apiRef) : gridExpandedSortedRowIdsSelector(apiRef);
    apiRef.current.selectRows(rowsToBeSelected, params.value);
  }, [apiRef, props.checkboxSelectionVisibleOnly, props.pagination]);
  const handleCellKeyDown = React123.useCallback((params, event) => {
...
var useGridRowSelectionPreProcessors = (apiRef, props) => {
  ...
  const updateSelectionColumn = React124.useCallback((columnsState) => {
...
var useGridSorting = (apiRef, props) => {
  ...
  const upsertSortModel = React125.useCallback((field, sortItem) => {
  ...
  const createSortItem = React125.useCallback((col, directionOverride) => {
  ...
  const addColumnMenuItem = React125.useCallback((columnMenuItems, colDef) => {
  ...
  const applySorting = React125.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const setSortModel = React125.useCallback((model) => {
  ...
  const sortColumn = React125.useCallback((column, direction, allowMultipleSorting) => {
    if (!column.sortable) {
      return;
    }
  ...
  const getSortModel = React125.useCallback(() => gridSortModelSelector(apiRef), [apiRef]);
  const getSortedRows = React125.useCallback(() => {
    const sortedRows = gridSortedRowEntriesSelector(apiRef);
    return sortedRows.map((row) => row.model);
  }, [apiRef]);
  const getSortedRowIds = React125.useCallback(() => gridSortedRowIdsSelector(apiRef), [apiRef]);
  const getRowIdFromRowIndex = React125.useCallback((index) => apiRef.current.getSortedRowIds()[index], [apiRef]);
  const sortApi = {
    getSortModel,
    getSortedRows,
    getSortedRowIds,
  ...
  const flatSortingMethod = React125.useCallback((params) => {
    const rowTree = gridRowTreeSelector(apiRef);
  ...
  const handleColumnHeaderClick = React125.useCallback(({
    colDef
  }, event) => {
    const allowMultipleSorting = event.shiftKey || event.metaKey || event.ctrlKey;
    sortColumn(colDef, void 0, allowMultipleSorting);
  }, [sortColumn]);
  const handleColumnHeaderKeyDown = React125.useCallback(({
    colDef
  }, event) => {
  ...
  const handleColumnsChange = React125.useCallback(() => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const handleStrategyProcessorChange = React125.useCallback((methodName) => {
...
var useGridScroll = (apiRef, props) => {
  ...
  const scrollToIndexes = React126.useCallback((params) => {
  ...
  const scroll = React126.useCallback((params) => {
  ...
  const getScrollPosition = React126.useCallback(() => {
...
function useGridDimensions(apiRef, props) {
  ...
  const errorShown = React127.useRef(false);
  const rootDimensionsRef = React127.useRef(null);
  const fullDimensionsRef = React127.useRef(null);
  const rowsMeta = useGridSelector(apiRef, gridRowsMetaSelector);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const rowHeight = Math.floor(props.rowHeight * densityFactor);
  const totalHeaderHeight = getTotalHeaderHeight(apiRef, props.columnHeaderHeight);
  const updateGridDimensionsRef = React127.useCallback(() => {
    var _apiRef$current$rootE;
  ...
  const [savedSize, setSavedSize] = React127.useState();
  const debouncedSetSavedSize = React127.useMemo(() => debounce(setSavedSize, 60), []);
  const previousSize = React127.useRef();
  useEnhancedEffect_default(() => {
    if (savedSize) {
  ...
  const resize = React127.useCallback(() => {
    apiRef.current.computeSizeAndPublishResizeEvent();
  }, [apiRef]);
  const getRootDimensions = React127.useCallback(() => fullDimensionsRef.current, []);
  const getViewportPageSize = React127.useCallback(() => {
    const dimensions = apiRef.current.getRootDimensions();
    if (!dimensions) {
      return 0;
    }
  ...
  const computeSizeAndPublishResizeEvent = React127.useCallback(() => {
  ...
  const isFirstSizing = React127.useRef(true);
  const handleResize = React127.useCallback((size) => {
...
var useGridVirtualScroller = (props) => {
  ...
  const currentPage = useGridVisibleRows(apiRef, rootProps);
  const renderZoneRef = React128.useRef(null);
  const rootRef = React128.useRef(null);
  const handleRef = useForkRef(ref, rootRef);
  const [renderContext, setRenderContextState] = React128.useState(null);
  const prevRenderContext = React128.useRef(renderContext);
  const scrollPosition = React128.useRef({
    top: 0,
    left: 0
  });
  const [containerDimensions, setContainerDimensions] = React128.useState({
    width: null,
    height: null
  });
  const prevTotalWidth = React128.useRef(columnsTotalWidth);
  const [hoveredRowId, setHoveredRowId] = React128.useState(null);
  const rowStyleCache = React128.useRef(/* @__PURE__ */ Object.create(null));
  const prevGetRowProps = React128.useRef();
  const prevRootRowStyle = React128.useRef();
  const getRenderedColumnsRef = React128.useRef(defaultMemoize((columns, firstColumnToRender, lastColumnToRender, minFirstColumn, maxLastColumn, indexOfColumnWithFocusedCell2) => {
  ...
  const indexOfColumnWithFocusedCell = React128.useMemo(() => {
    if (cellFocus !== null) {
      return visibleColumns.findIndex((column) => column.field === cellFocus.field);
    }
    return -1;
  }, [cellFocus, visibleColumns]);
  const getNearestIndexToRender = React128.useCallback((offset) => {
  ...
  const computeRenderContext = React128.useCallback(() => {
    if (!enabled) {
      return {
        firstRowIndex: 0,
  ...
  const handleResize = React128.useCallback(() => {
    if (rootRef.current) {
      setContainerDimensions({
        width: rootRef.current.clientWidth,
        height: rootRef.current.clientHeight
  ...
  const updateRenderZonePosition = React128.useCallback((nextRenderContext) => {
    const [firstRowToRender, lastRowToRender] = getRenderableIndexes({
  ...
  const getRenderContext = React128.useCallback(() => prevRenderContext.current, []);
  const setRenderContext = React128.useCallback((nextRenderContext) => {
  ...
  const indexOfRowWithFocusedCell = React128.useMemo(() => {
    if (cellFocus !== null) {
  ...
  const contentSize = React128.useMemo(() => {
  ...
  const rootStyle = React128.useMemo(() => {
    const style = {};
...
function GridColumnGroupHeader(props) {
  ...
  const rootProps = useGridRootProps();
  const headerCellRef = React129.useRef(null);
  const apiRef = useGridApiContext();
  ...
  const renderParams = React129.useMemo(() => ({
    groupId,
    headerName,
    description,
    depth,
  ...
  const publish = React129.useCallback(
    (eventName) => (event) => {
      if (isEventTargetInPortal(event)) {
        return;
      }
  ...
  const mouseEventsHandlers = React129.useMemo(() => ({
...
var useGridColumnHeaders = (props) => {
  ...
  const theme = useTheme();
  const [dragCol, setDragCol] = React130.useState("");
  const [resizeCol, setResizeCol] = React130.useState("");
  const apiRef = useGridPrivateApiContext();
  const hasVirtualization = useGridSelector(apiRef, gridVirtualizationColumnEnabledSelector);
  const rootProps = useGridRootProps();
  const innerRef = React130.useRef(null);
  const handleInnerRef = useForkRef(innerRefProp, innerRef);
  const [renderContext, setRenderContextRaw] = React130.useState(null);
  const prevRenderContext = React130.useRef(renderContext);
  const prevScrollLeft = React130.useRef(0);
  const currentPage = useGridVisibleRows(apiRef, rootProps);
  const totalHeaderHeight = getTotalHeaderHeight(apiRef, rootProps.columnHeaderHeight);
  const headerHeight = Math.floor(rootProps.columnHeaderHeight * densityFactor);
  const setRenderContext = React130.useCallback((nextRenderContext) => {
  ...
  const getFirstColumnIndexToRenderRef = React130.useRef(defaultMemoize(getFirstColumnIndexToRender, {
    equalityCheck: (a, b) => ["firstColumnIndex", "minColumnIndex", "columnBuffer"].every((key) => a[key] === b[key])
  }));
  const updateInnerPosition = React130.useCallback((nextRenderContext) => {
    const [firstRowToRender, lastRowToRender] = getRenderableIndexes({
      firstIndex: nextRenderContext.firstRowIndex,
      lastIndex: nextRenderContext.lastRowIndex,
      minFirstIndex: 0,
  ...
  const handleScroll = React130.useCallback(({
    left,
  ...
  const handleColumnResizeStart = React130.useCallback((params) => setResizeCol(params.field), []);
  const handleColumnResizeStop = React130.useCallback(() => setResizeCol(""), []);
  const handleColumnReorderStart = React130.useCallback((params) => setDragCol(params.field), []);
  const handleColumnReorderStop = React130.useCallback(() => setDragCol(""), []);
...
var GridBaseColumnHeaders = React131.forwardRef(function GridColumnHeaders(props, ref) {
  const {
    className
...
var GridColumnHeadersInner = React132.forwardRef(function GridColumnHeadersInner2(props, ref) {
  var _apiRef$current$getRo, _apiRef$current$getRo2;
  const {
    isDragging,
    className
...
var GridColumnHeaders2 = React133.forwardRef(function GridColumnsHeaders(props, ref) {
  const {
    innerRef,
    visibleColumns,
    sortColumnLookup,
...
var GridNoResultsOverlay = React134.forwardRef(function GridNoResultsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var GridColumnUnsortedIcon = React135.memo(function GridColumnHeaderSortIcon2(props) {
  const {
    sortingOrder
...
var useDataGridProps = (inProps) => {
  ...
  const localeText = React138.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const slots = React138.useMemo(() => computeSlots({
    defaultSlots,
...
var useGridRowsMeta = (apiRef, props) => {
  ...
  const rowsHeightLookup = React139.useRef(/* @__PURE__ */ Object.create(null));
  ...
  const getRowHeight = React139.useCallback((rowId) => {
  ...
  const setRowHeight = React139.useCallback((id, height) => {
    rowsHeightLookup.current[id].sizes.baseCenter = height;
    rowsHeightLookup.current[id].isResized = true;
    rowsHeightLookup.current[id].needsFirstMeasurement = false;
    hydrateRowsMeta();
  }, [hydrateRowsMeta]);
  const debouncedHydrateRowsMeta = React139.useMemo(() => debounce(hydrateRowsMeta, props.rowPositionsDebounceMs), [hydrateRowsMeta, props.rowPositionsDebounceMs]);
  const storeMeasuredRowHeight = React139.useCallback((id, height, position) => {
  ...
  const rowHasAutoHeight = React139.useCallback((id) => {
    var _rowsHeightLookup$cur2;
    return ((_rowsHeightLookup$cur2 = rowsHeightLookup.current[id]) == null ? void 0 : _rowsHeightLookup$cur2.autoHeight) || false;
  }, []);
  const getLastMeasuredRowIndex = React139.useCallback(() => {
    return lastMeasuredRowIndex.current;
  }, []);
  const setLastMeasuredRowIndex = React139.useCallback((index) => {
    if (hasRowWithAutoHeight.current && index > lastMeasuredRowIndex.current) {
      lastMeasuredRowIndex.current = index;
    }
  }, []);
  const resetRowHeights = React139.useCallback(() => {
...
var useGridColumnSpanning = (apiRef) => {
  ...
  const setCellColSpanInfo = React141.useCallback((rowId, columnIndex, cellColSpanInfo) => {
  ...
  const getCellColSpanInfo = React141.useCallback((rowId, columnIndex) => {
    var _lookup$current$rowId;
    return (_lookup$current$rowId = lookup.current[rowId]) == null ? void 0 : _lookup$current$rowId[columnIndex];
  }, []);
  const calculateCellColSpan = React141.useCallback((params) => {
    const {
      columnIndex,
      rowId,
      minFirstColumnIndex,
  ...
  const handleColumnReorderChange = React141.useCallback(() => {
    lookup.current = {};
  }, []);
...
var GridVirtualScroller = React143.forwardRef(function GridVirtualScroller2(props, ref) {
  const rootProps = useGridRootProps();
...
var GridVirtualScrollerContent = React144.forwardRef(function GridVirtualScrollerContent2(props, ref) {
  var _props$style;
  const rootProps = useGridRootProps();
...
var GridVirtualScrollerRenderZone = React145.forwardRef(function GridVirtualScrollerRenderZone2(props, ref) {
  const {
    className
...
var DataGridVirtualScroller = React146.forwardRef(function DataGridVirtualScroller2(props, ref) {
  const {
    className
